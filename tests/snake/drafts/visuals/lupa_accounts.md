...
The personality of Lupa Accounts is calm, composed, and reassuring.
...
* Ensure strong contrast between the wordmark and its background
* Use the wordmark alone in compact contexts; pair it with surrounding layout rather than extra decorative framing
...
Color usage should always prioritize legibility, balance, and calm contrast, with generous use of whitespace.
...
**Typography**
Typography should carry much of the product's premium character.

* Headings should feel elegant, confident, and clearly defined
* Body text should prioritize readability and reassurance
* Navigation and footer text should remain understated and compact
* Typography should remain consistent, structured, and easy to scan

Fallback fonts should include widely available sans-serif system fonts for stable rendering when custom fonts are unavailable.

**Imagery**
Imagery should align with the brand principles of trust, simplicity, and calm focus.
...
Lupa Accounts speaks to users who expect financial tools to feel secure, competent, and easy to understand. The brand is positioned as a private banking experience that removes friction and ambiguity rather than adding visual complexity.

It should be perceived as reliable, modern, and thoughtfully designed for people who value clarity, confidence, and a low-stress digital experience.

---

### Optional: Usage Guidelines and Examples

The Lupa Accounts identity should always be applied with consistency and restraint.
...
**Mission**
To make private banking interactions feel clear, secure, and easy to act on.

**Vision**
To be recognized as a digital banking experience that replaces complexity with confidence and calm.

**Values**

* Clarity over financial jargon
* Trust through consistency
* Simplicity without loss of professionalism
* Accessibility and ease of use
* Purposeful restraint in design
